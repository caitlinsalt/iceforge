...
and minor-level direct dependency updates.
...
- A major level dependency update has been applied to @types/node (to v22.14.0).
- Minor level dependency updates have been applied to fs-extra (to v11.3.0), luxon (to v3.6.1), @types/luxon (to v3.6.2), marked-highlight (to v2.2.1), eslint (to v9.24.0), @eslint/eslint-rc (to v3.3.1), @eslint/js (to v9.24.0) @typescript-eslint/eslint-plugin (to v8.29.0) and @typescript/eslint-parser (to v8.29.0).
- Patch level dependency updates have been applied to marked-gfm-heading-id (to v4.1.1), marked-mangle (to v1.1.10), marked-smartypants (to v1.1.9) and mime (to v4.0.7)
- In the blog template, a minor level dependency update has been applied to underscore (to v1.13.7). 
